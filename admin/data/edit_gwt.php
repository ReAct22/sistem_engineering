<?php
	...
	$idgwt = @$_GET['id'];
	$sql = mysqli_query($koneksi,"select *from pm_gwt where id_pmgwt = '$idgwt'");
...
<div class="card-body">
	...
	<form action="" method="post" enctype="multipart/form-data" class="form-group">
	  ...
	  <span class="input-group-text">NO. Unit</span>
	  	...
	  	<input type="text" name="no_pm" disabled="disabled" value="<?php echo $data['id_pmgwt'] ?>" class="form-control">
		</div>
	...
	if($edit_data){
		if($nama_gambar == ""){
			mysqli_query($koneksi,"update pm_gwt set periode = '$periode',
