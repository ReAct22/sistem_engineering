...
<div class="card-body">
	...
	<?php 
	$id = @$_GET['id'];
	$sql = mysqli_query($koneksi,"select *from pm_elektrical where id_pmelektrik = '$id'");
	...
	<form action="" method="post" class="form-group" enctype="multipart/form-data">
	  ...
	  <span class="input-group-text">NO. PM Elektrical</span>
		...
		<input type="text" name="no_pmelektrik" class="form-control" value="<?php echo $data['id_pmelektrik'] ?>">
	</div>
			<div class="input-group mb-3">
	  <div class="input-group-prepend">
	...
	if($edit_data){
			if($nama_gambar == ""){
				mysqli_query($koneksi,"update pm_elektrical set periode = '$periode', nama_utilitas = '$nama', lokasi_utilitas = '$lokasi', rencana = '$rencana', realisasi = '$realisasi' where id_pmelektrik = '$id'");
				?>
			...
			if($pindah){
				mysqli_query($koneksi,"update pm_elektrical set periode = '$periode', nama_utilitas = '$nama', lokasi_utilitas = '$lokasi', rencana = '$rencana', realisasi = '$realisasi', gambar = '$nama_gambar' where id_pmelektrik = '$id'");
				?>
					<script type="text/javascript">
