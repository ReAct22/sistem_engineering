...
<div style="margin-left: 30px;">
	<h2>Data Trafo</h2>
	<br>
	<a href="?page=tambah_dutrafo" class="btn btn-md btn-success ml-3"><i class="fas fa-plus"></i>Tambah Data Trafo</a>
	...
	<div class="card-body">
			...
			if($cek < 1){
				...
				<tr>
					...
					<td style="text-align: center;">
						<a href="?page=edit_dutrafo&id=<?php echo $data['id_trafo'] ?>" class="w3-bar-item w3-button w3-blue"><i class="fas fa-edit"></i>Edit</a>

						<a href="?page=delete_dutrafo&id=<?php echo $data['id_trafo'] ?>" class="w3-bar-item w3-button w3-red"><i class="fas fa-trash"></i>Hapus</a> 
					</td>
				</tr>
				<?php 
				}
      ...
      <div style="margin-top: 10px; float: right;">
        <?php 
          ...
          for($i=1; $i<=$jml_hal; $i++){
        ?>
        <a href="?page=du_trafo&hal=<?php echo $i; ?>" class="btn btn-outline-primary"><?php echo $i; ?></a>
        <?php
          }
        ?>
      </div>
