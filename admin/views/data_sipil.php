...
<div class="card-body">
	...
	if($cari_barang){
		...
		$sql = mysqli_query($koneksi,"select *from co_sipil LIMIT $posisi, $batas");
	}
...
<div style="margin-top: 10px;float: left;">
        <?php 
        $jml = mysqli_num_rows(mysqli_query($koneksi,"select *from co_sipil"));
      ...
      <div style="margin-top: 10px; float: right;">
        <?php 
          ...
          for($i=1; $i<=$jml_hal; $i++){
        ?>
        <a href="?page=sipil&hal=<?php echo $i; ?>" class="btn btn-outline-primary"><?php echo $i; ?></a>
        <?php
          }
        ?>
      </div>
