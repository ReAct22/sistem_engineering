<?php 
	...
	$query = mysqli_query($koneksi,"select max(id_stp) as kodePML from pm_stp");
...
<div style="margin-left: 30px;">
	...
	if($tambah_data){
		if($no_pmlift == "" || $tanggal_rencana == "" || $tanggal_realisasi == "" || $nama_equipmen == "" || $lokasi_equipmen == "" || $jenis_kerusakan == "" || $nama_teknisi == "" || $progres == "" || $keterangan == ""){
			?>
			...
			mysqli_query($koneksi, "insert into pm_stp values('$no_pmlift','$tanggal_rencana','$tanggal_realisasi','$nama_equipmen','$lokasi_equipmen','$jenis_kerusakan','$nama_teknisi','$progres','$keterangan')");
			?>
			<script type="text/javascript">
