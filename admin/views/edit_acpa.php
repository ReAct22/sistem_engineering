...
<div style="margin-left: 30px;">
	...
	<?php 
	$idacpa = @$_GET['idacpa'];
	$sql = mysqli_query($koneksi,"select *from du_ac_public_area where id_acpa = '$idacpa'");
	...
	<div class="card-body">
	  ...
	  <span class="input-group-text">NO.Utilitas</span>
			...
			<input type="text" name="no_utili" class="form-control" value="<?php echo $data['id_acpa'] ?>" disabled="disabled">
			</div>
	  ...
	  <span class="input-group-text">Keterangan</span>
		...
		if($edit_data){
				mysqli_query($koneksi,"update du_ac_public_area set nama_utilitas = '$nama_utili', lokasi_utilitas = '$lokasi', jumlah = '$jumlah', keterangan = '$keterangan' where id_acpa = '$idacpa' ");
				?>
