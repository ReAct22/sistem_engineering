...
<div style="margin-left: 30px;">
	<h2>Tambah Data Generator Set</h2>
	<div class="card-body">
	  ...
	  <span class="input-group-text">Keterangan</span>
		...
		if($tambah_data){
			if($no == "" || $nama_utili == "" || $lokasi == "" || $jumlah == "" || $keterangan == ""){
				...
				mysqli_query($koneksi,"insert into du_generator_set values('$no','$nama_utili','$lokasi','$jumlah', '$keterangan')");
				?>
