<?php
	...
	$idpt = @$_GET['id'];
	$sql = mysqli_query($koneksi,"select *from pm_pt where id_pt = '$idpt'");
...
<div class="card-body">
	...
	<form action="" method="post" enctype="multipart/form-data" class="form-group">
	  ...
	  <span class="input-group-text">NO. Unit</span>
	  	...
	  	<input type="text" name="no_pm" disabled="disabled" value="<?php echo $data['id_pt'] ?>" class="form-control">
		</div>
	...
	if($edit_data){
		if($nama_gambar == ""){
			mysqli_query($koneksi,"update pm_pt set periode = '$periode', 
					...
					nama_vendor = '$nama_vendor',
					 ...
					 rekomendasi = '$rekomendasi' where id_pt = '$idpt'");
			?>
