...
<div style="margin-left: 30px;">
	...
	<?php 
	$idtrafo = @$_GET['id'];
	$sql = mysqli_query($koneksi,"select *from du_trafo where id_trafo = '$idtrafo'");
	...
	<div class="card-body">
	  ...
	  <span class="input-group-text">NO. Utilitas</span>
			...
			<input type="text" name="no_utili" class="form-control" value="<?php echo $data['id_trafo'] ?>" disabled="disabled">
			</div>
	  ...
	  <span class="input-group-text">Keterangan</span>
		...
		if($edit_data){
				mysqli_query($koneksi,"update du_trafo set nama_utilitas = '$nama_utili', lokasi_utilitas = '$lokasi', jumlah = '$jumlah', keterangan = '$keterangan' where id_trafo = '$idtrafo' ");
				?>
