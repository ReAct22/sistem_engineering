...
<div style="margin-left: 30px;">
	...
	<?php 
	$query = mysqli_query($koneksi,"select max(id_me) as kodeME from du_me");
	...
	<div class="card-body">
	  ...
	  <span class="input-group-text">Name Equipment</span>
			...
			<input type="text" name="nama_utili" class="form-control" placeholder="Name Equipment">
			</div>
...
<div class="input-group mb-3">
	  ...
	  <span class="input-group-text">Spesifikasi</span>
			...
			<textarea class="form-control" name="keterangan" rows="3" placeholder="Spesifikasi"></textarea>
			</div>
		...
		if($tambah_data){
			if($no == "" || $nama_utili == "" || $lokasi == "" || $jumlah == "" || $keterangan == ""){
				...
				mysqli_query($koneksi,"insert into du_me values('$no','$nama_utili','$lokasi','$jumlah', '$keterangan')");
				?>
