...
<div style="margin-left: 30px;">
	...
	<br>
	<a href="?page=tambah_generator" class="btn btn-md btn-success ml-3"><i class="fas fa-plus"></i> Tambah Data</a>
	<a href="print_data/print_genset.php" class="btn btn-md btn-primary ml-3"><i class="fas fa-print"></i> Print</a>
	...
	if($cari_barang){
		if($cari != ""){
			$sql = mysqli_query($koneksi,"select *from du_generator_set where id_generator_set like '%$cari%' or nama_utilitas like '%$cari%' or lokasi_utilitas like '%$cari%'");
		}else{
		...
		while($data = mysqli_fetch_array($sql)){
			...
			<tr>
				...
				<td style="text-align: center;">
					<a href="?page=edit_genset&idgenset=<?php echo $data['id_generator_set'] ?>" class="btn btn-md btn-primary"><i class="fas fa-edit"></i>Edit</a>
					<a href="?page=delete_genset&idgenset=<?php echo $data['id_generator_set'] ?>" class="btn btn-md btn-danger"><i class="fas fa-trash"></i>Hapus</a> 
				</td>
			</tr>
			<?php 
				}
