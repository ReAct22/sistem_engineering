...
$query = mysqli_query($koneksi,"select max(id_utilitas) as kodeUtilitas from du_elektrical");
	  ...
	  <span class="input-group-text">Keterangan</span>
		...
		if($tambah_data){
			if($no == "" || $nama_utili == "" || $lokasi == "" || $jumlah == "" || $keterangan == ""){
				...
				mysqli_query($koneksi,"insert into du_elektrical values('$no','$nama_utili','$lokasi','$jumlah', '$keterangan')");
				?>
