<?php
	...
	$idpf = @$_GET['id'];
	$sql = mysqli_query($koneksi,"select *from pm_preasure_fan where id_pf = '$idpf'");
...
<div class="card-body">
	...
	<form action="" method="post" enctype="multipart/form-data" class="form-group">
	  ...
	  <span class="input-group-text">NO. Unit</span>
	  	...
	  	<input type="text" name="no_pm" disabled="disabled" value="<?php echo $data['id_pf'] ?>" class="form-control">
		</div>
	...
	if($edit_data){
		if($nama_gambar == ""){
			mysqli_query($koneksi,"update pm_preasure_fan set periode = '$periode', nama_utilitas = '$nama_utilitas',lokasi_utilitas = '$lokasi_utilitas', rencana = '$rencana', realisasi = '$realisasi', nama_vendor = '$nama_vendor', alamat_vendor = '$alamat_vendor',nama_teknisi = '$nama_teknisi',jenis_kerjaan = '$jenis_kerjaan', rekomendasi = '$rekomendasi' where id_pf = '$idpf'");
			?>
			...
			if($pindah){
				mysqli_query($koneksi,"update pm_preasure_fan set periode = '$periode', 
