...
<div style="margin-left: 30px;">
	...
	<h1 style="margin-left: 30px;">PREVENTIF MAINTENANCE GESET</h1>
	<a href="?page=tambah_geset" class="w3-bar-item w3-button w3-green"><i class="fas fa-plus"></i>Tambah Data</a>
	<a href="print_data/print_geset.php" class="w3bar-item w3-button w3-blue"><i class="fas fa-print"></i>Print</a>
	...
	if($cek < 1){
      ...
      <div style="margin-top: 10px; float: right;">
        <?php 
          ...
          for($i=1; $i<=$jml_hal; $i++){
        ?>
        <a href="?page=pm_geset&hal=<?php echo $i; ?>" class="btn btn-outline-primary"><?php echo $i; ?></a>
        <?php
          }
        ?>
      </div>
