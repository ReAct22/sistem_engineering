...
<a href="print_data/print_me.php" class="btn btn-md btn-primary ml-3"><i class="fas fa-print"></i> Print</a>
...
<div class="card-body">
	...
	if($cari_barang){
		...
		$sql = mysqli_query($koneksi,"select *from co_me LIMIT $posisi, $batas");
	}
...
<div style="margin-top: 10px;float: left;">
        <?php 
        $jml = mysqli_num_rows(mysqli_query($koneksi,"select *from co_me"));
      ...
      <div style="margin-top: 10px; float: right;">
        <?php 
          ...
          for($i=1; $i<=$jml_hal; $i++){
        ?>
        <a href="?page=me&hal=<?php echo $i; ?>" class="btn btn-outline-primary"><?php echo $i; ?></a>
        <?php
          }
        ?>
      </div>
