		...
		<?php 
			...
			if($tambah_data){
				if($unit_tn == "" || $nama_tn == "" || $kantor_tn == "" || $alamat_kantor_tn == "" || $email_kantor_tn == "" || $telpon_kantor_tn == "" || $negara_tn == "" || $kontak_tn == "" || $email_tn == "" || $masuk_tn == "" || $keluar_tn == ""){
					...
					mysqli_query($koneksi,"insert into tb_tenant values('$unit_tn','$nama_tn','$kantor_tn','$alamat_kantor_tn','email_kantor_tn','$telpon_kantor_tn','$negara_tn','$kontak_tn','$email_tn','$masuk_tn','$keluar_tn')");
					?>
						<script type="text/javascript">
